...
import com.docuverse.backend.configuration.CosineSimilarity;
 ...
 */
public class mypinecone implements EmbeddingStore<TextSegment> {
     ...
     */
    public mypinecone(String apiKey,
                                  String environment,
                                  String projectId,
                                  String index) {
            ...
            if (textSegments != null) {
                vectorBuilder.setMetadata(Struct.newBuilder()
                        .putFields(METADATA_TEXT_SEGMENT, Value.newBuilder()
                                ...
                                .build())
                        .putFields("this is a test",Value.newBuilder()
                                .setStringValue("sdsa")
                                .build()));
            }
    ...
    public static class Builder {
        ...
        public mypinecone build() {
            return new mypinecone(apiKey, environment, projectId, index);
        }
    }
}
